...
const dictionary: Record<string, DictionaryEntry> = {
    ...
    'inspector.view_source': { en: 'View Source', sv: 'Visa källa' },
    'inspector.verified': { en: 'Verified', sv: 'Verifierad' },
    'inspector.market_range': { en: 'Market Range', sv: 'Marknadsintervall' },
