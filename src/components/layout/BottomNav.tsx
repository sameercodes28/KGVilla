        ...
        <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-slate-200 px-4 py-2 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
            ...
            <div className="flex justify-center items-center">
                <Link
                    href="/"
                    className={cn(
                        "flex flex-col items-center p-2 px-6 rounded-xl transition-all duration-300",
            ...
            {/* Language Toggle - Fixed to far right */}
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 bg-slate-100 rounded-full p-0.5">
                <button
