...
export function ContractScope({ totalCost }: ContractScopeProps) {
    const paymentSteps = [
        ...
        { label: "Structure Erected (Weather-tight)", percent: 35, amount: totalCost * 0.35 },
        { label: "Interior Works", percent: 20, amount: totalCost * 0.20 },
        { label: "Final Inspection (Slutbesiktning)", percent: 10, amount: totalCost * 0.10 },
    ];
    ...
    return (
        <div className="mb-8">
            <CollapsibleSection 
                ...
                subtitle="Standard JB Villan Terms (ABT 06)" 
                ...
                <div className="p-4 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-green-50 p-3 rounded-xl border border-green-100 flex flex-col items-center text-center">
                            ...
                            <div className="text-sm font-bold text-green-800">10-Year Warranty</div>
                            <div className="text-[10px] text-green-600">Defect Liability Period</div>
                        </div>
                        <div className="bg-blue-50 p-3 rounded-xl border border-blue-100 flex flex-col items-center text-center">
                            <FileText className="h-6 w-6 text-blue-600 mb-2" />
                            <div className="text-sm font-bold text-blue-800">Fixed Price</div>
                            <div className="text-[10px] text-blue-600">Consumer Protection Law</div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="flex items-center space-x-2 mb-3">
                            ...
                            <h4 className="text-sm font-semibold text-slate-700">Payment Schedule (Betalningsplan)</h4>
                        </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs text-slate-500 flex items-start">
                        ...
                        <p>
                            <strong>Included:</strong> Scaffolding, Dehumidifiers, Temporary Electricity, Site Cleaning, Project Management (BAS-U). <br/>
                            <strong>Excluded:</strong> Fine landscaping (grass/hedges) unless specified.
                        </p>
                    </div>
                </div>
            </CollapsibleSection>
