                ...
                <div className="flex justify-between items-start">
                    <div className="flex-1">
                        <div className="flex items-center space-x-2">
                            ...
                            {item.isUserAdded && (
                                <span className="px-1.5 py-0.5 bg-purple-100 text-purple-700 text-[10px] font-bold uppercase rounded">Custom</span>
                            )}
                            {hasCustomValues && !item.isUserAdded && (
                                <span className="px-1.5 py-0.5 bg-amber-100 text-amber-700 text-[10px] font-bold uppercase rounded">Edited</span>
                            )}
                        </div>
                ...
                <div className="px-4 pb-4 pt-0 bg-slate-50/50 border-t border-slate-100">
                    ...
                    {item.options && (
                        <div className="mb-4 pt-4">
                            <h5 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Select Option</h5>
                    ...
                    <div className="mb-4 p-3 bg-slate-50 rounded-xl border border-slate-100">
                        <h5 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Estimated Breakdown</h5>
                        ...
                        {item.calculationLogic && (
                            <div className="bg-blue-50 rounded-xl p-3 border border-blue-100">
                                <div className="flex items-center text-blue-700 mb-1">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wide">AI Calculation</span>
                                </div>
                        ...
                        {item.guidelineReference && (
                            <div className="bg-slate-100 rounded-xl p-3 border border-slate-200">
                                <div className="flex items-center text-slate-600 mb-1">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wide">Guideline</span>
                                </div>
                                <p className="text-sm text-slate-700 leading-relaxed">
                                    {item.guidelineReference}
                                </p>
