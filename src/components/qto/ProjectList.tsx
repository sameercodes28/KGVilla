            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.map((project) => (
                    <Link key={project.id} href={`/qto?project=${project.id}`} className="block group">
                        <div className="h-48 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-red-300 transition-all flex flex-col">
                            ...
                            <div className="px-6 py-4 border-t border-slate-50 bg-slate-50/50 rounded-b-2xl flex justify-between items-center text-sm text-slate-500 group-hover:text-red-600">
